    ...
    return (
      <div className='container-fluid'>
        <div className='row d-flex'>
          <div className='col-4' >
            <div>
              <Card className='best-times-card w-100'style={{height:'200px'}}>
                <CardBody>
          ...
          <div className='col-8' >
            <div class='d-flex flex-column bd-highlight mb-3'>
              <div className='summary-row'>
                <Card className='my-card-summary-row p-2 bd-highlight'style={{height:'200px'}}>
                  <div className='row'>
                    <div className='title-col col'>
                      ...
                      <a href={this.props.place.yelp_url} target='_blank' rel="noopener noreferrer">
                        {" "}
                    ...
                    <div className='info-col col'>
                      ...
                      <p className='card-price info-p'>
                        {this.props.place.yelp_categories.map((category)=>{return category.title + " "})}
                      </p>
                    ...
                    <div className='hotspot-col col'>
                      ...
                      <p className='hotspot-score-number'>
                        {this.props.place.current_hot_score}<small>%</small>
                      </p>
                    </div>
                  </div>
                </Card>
